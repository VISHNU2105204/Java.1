/*Practical7 : Write a program calculates the distance between two cities based on
their latitude and longitude coordinates. All you need to do is ask the user for the
latitude and longitude of two cities and then print out the distance between them.*/
...
public class Practical7 {
	...
	public static void main(String[] args) {
		...
		System.out.println("Distance Between the two cities is: " +
                distance + " Kilometers");
		}
	}
